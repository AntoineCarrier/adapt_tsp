...
def parse_args():
    ...
    parser.add_argument("--B", type = float, default = 0.004)
...
def main():
    ...
    with open('gr17_standard_instance_graph.json', 'r') as file:
        data = json.load(file)
    ...
    with open("standard_instance_gr17_test_results.json", "w") as outfile:
